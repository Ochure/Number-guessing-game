...
A fun and interactive Python game where the computer randomly selects a number, and the player must guess it within a limited number of attempts.

Features
Random Number Generation: The computer picks a random number.

Difficulty Levels: Choose between easy, medium, and hard.

Limited Attempts: You have a limited number of chances to guess the correct number.
...
Copy
Edit
git clone https://github.com/Ochure/Number-guessing-game.git
